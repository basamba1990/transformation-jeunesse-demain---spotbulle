...
const HomePage: React.FC = () => {
  ...
  // Fonction pour gérer les erreurs de chargement audio
  const handleAudioError = (e: React.SyntheticEvent<HTMLAudioElement, Event>) => {
    console.warn("Erreur de chargement audio:", e);
    // Masquer l'élément audio en cas d'erreur
    ...
    if (parent) {
      ...
      errorMsg.textContent = 'Audio temporairement indisponible';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-earth-100 dark:from-dark-bg dark:to-dark-surface texture-paper">
      <header className="relative overflow-hidden py-20 md:py-32 fade-in">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            {/* Intégration du logo SpotBulle avec gestion d'erreur */}
            <div className="w-full md:w-auto flex justify-center">
              <img 
                ...
                onError={(e) => {
                  // Remplacer par une div colorée en cas d'erreur
                  const target = e.currentTarget;
                  const parent = target.parentElement;
                  if (parent) {
                    const placeholder = document.createElement('div');
                    placeholder.className = 'w-64 h-64 rounded-full bg-gradient-to-r from-primary-400 to-accent-400 flex items-center justify-center text-white text-2xl font-bold';
                    placeholder.textContent = 'SpotBulle';
      ...
      {/* Section Spotter sa voix - Intégration de l'image promotionnelle avec gestion d'erreur */}
      <section className="my-12 container mx-auto px-4">
        <div className="bg-purple-600 rounded-xl overflow-hidden shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative h-full min-h-[300px] md:min-h-0 bg-purple-500">
              <img 
                src="/assets/spotter_sa_voix.jpg" 
                alt="Jeune au microphone" 
                className="absolute inset-0 w-full h-full object-cover"
                onError={(e) => {
                  // En cas d'erreur, masquer l'image et afficher un dégradé
                  const target = e.currentTarget;
                  target.style.display = 'none';
                  const parent = target.parentElement;
                  if (parent) {
                    parent.classList.add('bg-gradient-to-r', 'from-purple-500', 'to-purple-700');
                    
                    // Ajouter une icône de microphone
                    const icon = document.createElement('div');
                    icon.className = 'absolute inset-0 flex items-center justify-center text-white';
      ...
      {/* Section IA - Intégration de l'image Huxe avec gestion d'erreur */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-gray-800 to-black">
                <img 
                  src="/assets/huxe_particles.jpg" 
                  alt="Intelligence personnelle" 
                  className="w-full h-full object-contain"
                  onError={(e) => {
                    // En cas d'erreur, masquer l'image et afficher un effet de particules
                    const target = e.currentTarget;
                    target.style.display = 'none';
                    
                    // Créer un effet de particules avec des points
                    const parent = target.parentElement;
                    if (parent) {
                      for (let i = 0; i < 50; i++) {
      ...
      {/* Section Ressources Audio avec gestion d'erreur */}
      <section className="my-12 container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-6 text-center">Ressources audio</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Remplacer les AudioResourceCard par une version avec gestion d'erreur */}
          <div className="bg-white dark:bg-dark-surface p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Modèle économique</h3>
            <p className="text-neutral-600 dark:text-neutral-400 mb-4">
              Présentation du modèle économique de SpotBulle et de son impact sur la jeunesse.
            </p>
            <div className="mt-4">
              <audio 
                controls 
              ...
              >
                <source src="/assets/audio/EconomicModel.wav" type="audio/wav" />
                Votre navigateur ne supporte pas l'élément audio.
              </audio>
              <div className="text-xs text-neutral-500 mt-2">
                Note: Ce fichier audio est temporairement indisponible en mode développement.
              </div>
            </div>
          </div>
          
          <div className="bg-white dark:bg-dark-surface p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Transformation Jeunesse</h3>
            <p className="text-neutral-600 dark:text-neutral-400 mb-4">

...
export const authService = {
  // CORRECTION : Modifier la signature pour accepter un objet avec email et password
  loginUser: async (userData: { email: string; password: string }): Promise<string> => {
    const params = new URLSearchParams();
    params.append("username", userData.email); // Utiliser userData.email au lieu de credentials.email
    params.append("password", userData.password); // Utiliser userData.password au lieu de credentials.password

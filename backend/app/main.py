...
# Configuration CORS CORRIGÉE - Suppression du wildcard "*"
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        ...
        "http://127.0.0.1:5173"                      # Développement local alternatif
        # SUPPRESSION DE "*" pour résoudre le problème CORS avec credentials
    ],
